...
$(document).on("click", ".portfolio-item", function () {
  var self = $(this);
  popup.setAttribute("iframe", "src", "/"+self.data("username")+"/"+self.data("slug"));
  popup.find("iframe").contentWindow.focus();
  popup.setAttribute(".btn-launch.for-mobile", "href", "/"+self.data("username")+"/"+self.data("slug"));
  popup.setAttribute(".project-detail", "href", self.data("username"));
